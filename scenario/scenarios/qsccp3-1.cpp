...
namespace ns3
{
    ...
    main(int argc, char *argv[])
    {
        ...
        ndn::L3RateTracer::InstallAll("qsccp3-1-throughput-320.txt", Seconds(0.5));
        ndn::AppDelayTracer::InstallAll("qsccp3-1-delay-320.txt");
        L2RateTracer::InstallAll("qsccp3-1-drop-320.txt", Seconds(0.5));
        Simulator::Run();
        Simulator::Destroy();
