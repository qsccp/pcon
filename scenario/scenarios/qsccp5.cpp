...
namespace ns3
{
    ...
    main(int argc, char *argv[])
    {
        ...
        ndn::L3RateTracer::InstallAll("pcon-throughput.txt", Seconds(0.1));
        ndn::AppDelayTracer::InstallAll("pcon-delay.txt");
        L2RateTracer::InstallAll("pcon-drop.txt", Seconds(0.1));
        Simulator::Run();
        Simulator::Destroy();
