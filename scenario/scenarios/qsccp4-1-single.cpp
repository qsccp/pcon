...
namespace ns3
{
    ...
    main(int argc, char *argv[])
    {
        ...
        ndn::L3RateTracer::InstallAll("pcon-single-throughput.txt", Seconds(0.1));
        ndn::AppDelayTracer::InstallAll("pcon-single-delay.txt");
        L2RateTracer::InstallAll("pcon-single-drop.txt", Seconds(0.1));
        Simulator::Run();
        Simulator::Destroy();
