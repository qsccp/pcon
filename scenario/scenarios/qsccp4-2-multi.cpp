...
namespace ns3
{
    ...
    main(int argc, char *argv[])
    {
        ...
        ndn::L3RateTracer::InstallAll("pcon-multi-throughput.txt", Seconds(0.1));
        ndn::AppDelayTracer::InstallAll("pcon-multi-delay.txt");
        L2RateTracer::InstallAll("pcon-multi-drop.txt", Seconds(0.1));
        Simulator::Run();
        Simulator::Destroy();
